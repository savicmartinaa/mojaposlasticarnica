 ...
 * Use the [EditPersonalDataFragment.newInstance] factory method to
...
class EditPersonalDataFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EditPersonalDataFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EditPersonalDataFragment().apply {
